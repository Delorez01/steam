	...
	<div class="col-12" style="background-color: #212429; height: 900px;">
		<div class="col-8 mx-auto pt-5">
				<h1 class="text-uppercase text-light mt-5 fw-light">Создание аккаунта</h1>
					...
					<p class="text-white m-0">Выберите аватар</p>
					<input type="file" name="avatar" class="w-25 form-control bg-dark" style="color: white;">

					<p class="text-white m-0">Имя аккаунта Steam</p>
					<input type="text" name="username" class="w-25 form-control bg-dark" style="color: white;">

					<p class="text-white m-0 mt-3">Электронная почта</p>
					<input type="email" name="email" class="w-25 form-control bg-dark" style="color: white;">

					<p class="text-white m-0  mt-3">Возраст</p>
					<input type="number" name="age" class="w-25 form-control bg-dark" style="color: white;">
